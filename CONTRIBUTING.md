# Contributing to coder-flow

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
coder-flow. These guidelines are not strict rules.
...
The coder-flow team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the coder-flow technical leads
...
[issues]: https://github.com/monarch-initiative/coder-flow/issues/
[pulls]: https://github.com/monarch-initiative/coder-flow/pulls/
